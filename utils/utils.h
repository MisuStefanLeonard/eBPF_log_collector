...
#define MAX_ITERS_FOR_STRSTR 150
...
typedef struct {
    ...
    /*De scos */
    // unsigned int i_bdev_major; // 4
    // unsigned int i_bdev_minor; // 4
    // unsigned int i_bdev_major_new; // 4
    // unsigned int i_bdev_minor_new; // 4
    /*De scos */
    ...
    /*De scos */
    // unsigned char was_size_extended; // 1
    // unsigned char was_size_truncated; // 1
    /*De scos */
    ...
    /*De scos */
    // unsigned char is_rdev_bdev_mismatch; // 1
    // unsigned char is_rdev_bdev_mismatch_new; // 1
    /*De scos */
